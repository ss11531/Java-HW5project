...
public class LoginCoUI extends JFrame {
	...
	public LoginCoUI() {
		...
		lblNewLabel.setBounds(176, 27, 193, 65);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("帳號：");
		lblNewLabel_1.setFont(new Font("微软雅黑 Light", Font.BOLD, 20));
		lblNewLabel_1.setBounds(91, 102, 62, 46);
		...
		username.setBounds(165, 102, 233, 46);
		contentPane.add(username);
		
		JLabel lblNewLabel_2 = new JLabel("密碼：");
		lblNewLabel_2.setFont(new Font("微软雅黑 Light", Font.BOLD, 20));
		lblNewLabel_2.setBounds(91, 170, 62, 46);
		...
		password.setBounds(165, 170, 233, 46);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {String Username = username.getText();
			String Password = password.getText();
			// 帳號與密碼格式正確後，執行登入驗證
			Consumer consumer = new ConsumerServiceImpl().Login(Username, Password);
			if (consumer != null) {
			    Tool.save(consumer, "consumer.txt");
			    LoginCoSuccessUI loginsuccess = new LoginCoSuccessUI();
			    loginsuccess.setVisible(true);
			    dispose();
			} else {
			    LoginCoErrorUI loginerror = new LoginCoErrorUI();
		...
		btnNewButton.setBounds(53, 244, 132, 52);
		...
		btnNewButton_1.setBounds(209, 244, 132, 52);
		contentPane.add(btnNewButton_1);
		
		btnNewButton_2 = new JButton("離開");
		...
		btnNewButton_2.setBounds(362, 244, 90, 52);
		contentPane.add(btnNewButton_2);
		
		label_1 = new JLabel("");
		label_1.setFont(new Font("微软雅黑 Light", Font.BOLD, 15));
		label_1.setBounds(10, 10, 308, 46);
