...
public class AddEmUI extends JFrame {
	...
	public AddEmUI() {
		...
		panel.setBounds(0, 10, 548, 61);
		contentPane.add(panel);
		
		JLabel lblNewLabel_1 = new JLabel("新增員工資料");
		...
		panel_1.setBounds(0, 87, 548, 418);
			...
			public void mouseClicked(MouseEvent e) {
...

				{
					if (new MemberServiceImpl().isUsernameBeenUse(Username)) {
						AddEmErrorUI addmembererror = new AddEmErrorUI();
						...
						Member member = new Member(Employeeno, Name, Username, Password, Address, Mobile);
						
						new MemberServiceImpl().addMember(member);

						AddEmSuccessUI addmembersuccess = new AddEmSuccessUI();
		...
		employeeno.setFont(new Font("微软雅黑 Light", Font.BOLD, 20));
		employeeno.setColumns(10);
		employeeno.setBounds(157, 19, 286, 34);
		panel_1.add(employeeno);
		
		JLabel lblNewLabel_1_1_1_1_1_1_1_1 = new JLabel("工號");
